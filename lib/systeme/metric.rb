module Systeme
  module Metric
    ...
    def self.included(caller)
      ...
      caller.send :include, Systeme::Metric::Conversions
    end    
    
    module Declarations
      SI_BASE_UNITS.each do |unit, unit_data|
        ...
        SI_UNIT_PREFIXES.each do |prefix, prefix_data|
    ...
    module Conversions
      def method_missing(method_id, *arguments)
        if match = method_id.to_s.match(/to_([a-zA-Z]+)/)
